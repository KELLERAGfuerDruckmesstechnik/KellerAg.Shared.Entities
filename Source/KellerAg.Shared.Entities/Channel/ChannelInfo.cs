    ...
    public class ChannelInfo
    {
        ...
        internal static ChannelInfo[] GetNewChannelsInstance()
        {
            return new[]{
                    ...
                    new ChannelInfo(ChannelType.CounterIn      , (int)ChannelType.CounterIn      , "Counter input"   , "", "#000000", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH1      , (int)ChannelType.SDI12_CH1      , "SDI12 CH1"       , "", "#000000", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH2      , (int)ChannelType.SDI12_CH2      , "SDI12 CH2"       , "", "#212121", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH3      , (int)ChannelType.SDI12_CH3      , "SDI12 CH3"       , "", "#454545", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH4      , (int)ChannelType.SDI12_CH4      , "SDI12 CH4"       , "", "#737373", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH5      , (int)ChannelType.SDI12_CH5      , "SDI12 CH5"       , "", "#a2a2a2", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH6      , (int)ChannelType.SDI12_CH6      , "SDI12 CH6"       , "", "#2196f3", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH7      , (int)ChannelType.SDI12_CH7      , "SDI12 CH7"       , "", "#1a75bf", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH8      , (int)ChannelType.SDI12_CH8      , "SDI12 CH8"       , "", "#005ca8", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH9      , (int)ChannelType.SDI12_CH9      , "SDI12 CH9"       , "", "#003866", UnitType.Unitless),
                    new ChannelInfo(ChannelType.SDI12_CH10     , (int)ChannelType.SDI12_CH10     , "SDI12 CH10"      , "", "#66baff", UnitType.Unitless),
                    ...
                    new ChannelInfo(ChannelType.Converter_Voltage_In           , (int)ChannelType.Converter_Voltage_In     , "Converter Voltage In"     , "", "#000000", UnitType.Voltage),
                    new ChannelInfo(ChannelType.Converter_Voltage_Out          , (int)ChannelType.Converter_Voltage_Out    , "Converter Voltage Out"    , "", "#000000", UnitType.Voltage),
                    new ChannelInfo(ChannelType.Converter_Voltage_USB          , (int)ChannelType.Converter_Voltage_USB    , "Converter Voltage USB"    , "", "#000000", UnitType.Voltage),
                    new ChannelInfo(ChannelType.Converter_Current_Out          , (int)ChannelType.Converter_Current_Out    , "Converter Current Out"    , "", "#000000", UnitType.Voltage),
                    ...
                    new ChannelInfo(ChannelType.P_Absolute                     , (int)ChannelType.P_Absolute               , "P Abs"          , "", "#107c10", UnitType.Pressure),
                    new ChannelInfo(ChannelType.P_Relative                     , (int)ChannelType.P_Relative               , "P Rel"          , "", "#003b00", UnitType.Pressure),
